...
public class Main2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] permissions = {Manifest.permission.READ_PHONE_STATE, Manifest.permission.ACCESS_NETWORK_STATE, Manifest.permission.BLUETOOTH};
        if (ContextCompat.checkSelfPermission(Main2.this, Manifest.permission.READ_PHONE_STATE)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(Main2.this, permissions, 0);
        }
    ...
    private void init() {
        ...
        if (ContextCompat.checkSelfPermission(Main2.this, Manifest.permission.READ_PHONE_STATE)
